...
<head>
    ...
    <style>
        body {
            ...
            height: 100vh;
            margin: 0;
            background-image: url('../back_end/imagem/maria-joaquina-e-cirilo-materia2.png'); /* Caminho da sua imagem */
...
<body>
    ...
    <?php echo $_SESSION['nome']; ?>
        <a href="../back_end/emprestimo/criar_emprestimo.php" class="botao">Empréstimo</a>
        <a href="../back_end/livro/buscar_livro.php" class="botao">Buscar Livro</a>
        <a href="http://localhost:8081/biblioteca/biblioteca/back_end/professor/criar_professor.php" class="botao">Cadastros professor</a>
        <a href="http://localhost:8081/biblioteca/biblioteca/back_end/aluno/criar_aluno.php" class="botao">Cadastros aluno</a>
        <a href="http://localhost:8081/biblioteca/biblioteca/backup/listas_gerais.php" class="botao">Listas Gerais</a>
    </div>
