...
<body>
    ...
    <div class="container">
        ...
        <a href="http://localhost:8081/tcc/back_end/professor/criar_professor.php" class="botao">Cadastros professor</a>
        <a href="http://localhost:8081/tcc/back_end/aluno/criar_aluno.php" class="botao">Cadastros aluno</a>
        <a href="http://localhost:8081/tcc/backup/listas_gerais.php" class="botao">Listas Gerais</a>
    </div>
